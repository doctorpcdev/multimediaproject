...
@section('titulo')
	 <h1 class="page-header">Anuncios Esteli</h1>
@stop
		...
		<div class="tab-pane fade" id="addArticulo" style="margin-top: 20px">
			...
			{{ Form::open(array('url' => 'administrador/anuncios/create', 'files' => true, 'class' => 'form-horizontal')) }}
				...
				<div class="form-group">
					...
					<div class="col-sm-6">
						{{ Form::text('departamento', Input::old('departamento') ? Input::old('departamento') : 'Esteli', array('class' => 'form-control', 'id' => 'disabledInput', 'placeholder'=> 'Departamento del Anuncio')) }}	
					</div>
				</div>
				<div class="form-group">
